...
#ifndef FILTERLOGVIEWMOVEDMODEL_H
#define FILTERLOGVIEWMOVEDMODEL_H
...
class FilterLogViewMovedModel : public QAbstractItemModel
{
  ...
  private:
    ...
    /**
     * @brief This list contains the items which represents the moved mails.
     *
...
#endif // FILTERLOGVIEWMOVEDMODEL_H
